...
public class Engine {
    ...
    public TETile[][] interactWithInputString(String input) {
        ...
        input = input.toUpperCase(); //This is to satisfy case insensitivity.
        String seed = input.substring(0, input.indexOf('S'));
        WorldGen world = new WorldGen(ter, seed, WIDTH, HEIGHT);
        world.buildallrooms();
